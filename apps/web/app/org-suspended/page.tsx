...
export default async function OrgSuspendedPage({
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[var(--landing-bg)]">
      ...
      />
      <div
        className="pointer-events-none absolute top-1/2 left-1/2 -z-10 h-[350px] w-[350px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-amber-500/[0.06] blur-[100px]"
        aria-hidden="true"
      />
      <div className="max-w-md px-4 text-center">
        <span className="mb-4 inline-block rounded-full bg-amber-500/10 px-3 py-1 font-mono text-[11px] font-medium text-amber-500 uppercase">
          Suspended
        </span>
