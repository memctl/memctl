...
| Cursor            | `.cursor/mcp.json`                    | `mcpServers`      | `memctl init --cursor`   | `generate --cursor`       |
...
| Codex             | `.codex/config.toml`                  | `mcp_servers`     | `memctl init --codex`    | `generate` (AGENTS.md)    |
...
| Amazon Q          | `.amazonq/mcp.json`                   | `mcpServers`      | `memctl init --amazonq`  | `generate` (AGENTS.md)    |
