  ...
  return (
    <div className="divide-y divide-[var(--landing-border)]">
      {Array.from({ length: rows }).map((_, i) => {
        ...
        const showKey = i % 3 !== 2;
        return (
          <div key={i} className="flex items-center gap-2 px-3 py-1.5" style={{ opacity: 1 - i * 0.06 }}>
            ...
            {showKey && (
              <Skeleton className="h-3 rounded bg-[var(--landing-surface-2)]" style={{ width: keyWidth }} />
            )}
