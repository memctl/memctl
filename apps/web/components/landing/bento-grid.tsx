...
const STACK_ICONS = [
  "Next.js", "React", "Go", "Python", "Rust", "TypeScript",
  "Docker", "Kubernetes", "PostgreSQL", "Redis", "Node.js", "Zig",
];
...
function TreeViz() {
  return (
    <svg width="160" height="120" viewBox="0 0 160 120" fill="none" className="transition-transform duration-500 group-hover:scale-105">
      <circle cx="80" cy="16" r="5" fill="#F97316" className="animate-node-pulse" style={{ "--node-r": 5 } as React.CSSProperties} />
      <circle cx="40" cy="52" r="4" fill="#F97316" opacity="0.7" className="animate-node-pulse [animation-delay:400ms]" style={{ "--node-r": 4 } as React.CSSProperties} />
      <circle cx="120" cy="52" r="4" fill="#F97316" opacity="0.7" className="animate-node-pulse [animation-delay:800ms]" style={{ "--node-r": 4 } as React.CSSProperties} />
      ...
      <line x1="80" y1="21" x2="40" y2="48" stroke="#F97316" strokeWidth="1" opacity="0.5" />
      <line x1="80" y1="21" x2="120" y2="48" stroke="#F97316" strokeWidth="1" opacity="0.5" />
      <line x1="40" y1="56" x2="20" y2="87" stroke="#F97316" strokeWidth="0.7" opacity="0.4" />
      <line x1="40" y1="56" x2="60" y2="87" stroke="#F97316" strokeWidth="0.7" opacity="0.4" />
      <line x1="120" y1="56" x2="100" y2="87" stroke="#F97316" strokeWidth="0.7" opacity="0.4" />
      <line x1="120" y1="56" x2="140" y2="87" stroke="#F97316" strokeWidth="0.7" opacity="0.4" />
    </svg>
  );
}
...
function GitBranchViz() {
  return (
    <svg width="140" height="60" viewBox="0 0 140 60" fill="none" className="transition-transform duration-500 group-hover:scale-105">
      <line x1="10" y1="30" x2="130" y2="30" stroke="#F97316" strokeWidth="2" opacity="0.5" />
      <path d="M40 30 Q55 10 70 10 Q85 10 100 30" stroke="#F97316" strokeWidth="1.5" opacity="0.4" fill="none" />
      ...
      <circle r="3" fill="#F97316">
        <animateMotion dur="3s" repeatCount="indefinite" path="M10,30 L130,30" />
      </circle>
    </svg>
  );
}
...
function MCPViz() {
  return (
    <svg width="140" height="60" viewBox="0 0 140 60" fill="none" className="transition-transform duration-500 group-hover:scale-105">
      <rect x="4" y="15" width="40" height="30" rx="4" stroke="#F97316" strokeWidth="1" opacity="0.5" fill="none" />
      <text x="24" y="34" textAnchor="middle" fill="#F97316" fontSize="8" opacity="0.7" fontFamily="monospace">Agent</text>
      <rect x="96" y="15" width="40" height="30" rx="4" stroke="#F97316" strokeWidth="1" opacity="0.5" fill="none" />
      <text x="116" y="34" textAnchor="middle" fill="#F97316" fontSize="8" opacity="0.7" fontFamily="monospace">memctl</text>
      <line x1="48" y1="25" x2="92" y2="25" stroke="#F97316" strokeWidth="1" opacity="0.4" />
      <line x1="92" y1="35" x2="48" y2="35" stroke="#F97316" strokeWidth="1" opacity="0.4" />
      ...
      <circle r="2.5" fill="#4ADE80" opacity="0.8">
        <animateMotion dur="2.5s" repeatCount="indefinite" path="M92,35 L48,35" />
      </circle>
    </svg>
  );
}
...
function IndexingViz() {
  return (
    <svg width="160" height="80" viewBox="0 0 160 80" fill="none" className="transition-transform duration-500 group-hover:scale-105">
      ...
      <line x1="30" y1="20" x2="80" y2="15" stroke="#F97316" strokeWidth="0.7" opacity="0.4" />
      <line x1="80" y1="15" x2="130" y2="25" stroke="#F97316" strokeWidth="0.7" opacity="0.4" />
      <line x1="30" y1="20" x2="50" y2="55" stroke="#F97316" strokeWidth="0.7" opacity="0.4" />
      <line x1="130" y1="25" x2="110" y2="60" stroke="#F97316" strokeWidth="0.7" opacity="0.4" />
      <line x1="50" y1="55" x2="110" y2="60" stroke="#F97316" strokeWidth="0.7" opacity="0.4" />
      <line x1="0" y1="0" x2="0" y2="80" stroke="#F97316" strokeWidth="1.5" opacity="0">
        <animate attributeName="x1" values="0;160;0" dur="4s" repeatCount="indefinite" />
        <animate attributeName="x2" values="0;160;0" dur="4s" repeatCount="indefinite" />
...
function TimelineViz() {
  return (
    <svg width="140" height="50" viewBox="0 0 140 50" fill="none" className="transition-transform duration-500 group-hover:scale-105">
      <line x1="10" y1="25" x2="130" y2="25" stroke="#F97316" strokeWidth="1.5" opacity="0.4" />
      ...
      <g>
        <rect x="100" y="6" width="30" height="14" rx="3" fill="#F97316" opacity="0.25" />
        <text x="115" y="16" textAnchor="middle" fill="#F97316" fontSize="8" fontFamily="monospace" opacity="0.9">HEAD</text>
    ...
    >
      ...
      <ScrollReveal animation="fade-up" delay={150} style={{ display: "flex" }}>
        <BentoCard
          icon={Users}
          title="Team sync"
          description={'Every team member\'s agents share the same context. No more "works on my machine" for AI.'}
        />
      </ScrollReveal>
      ...
      <ScrollReveal animation="fade-up" delay={350} className="md:col-span-2 lg:col-span-4" style={{ display: "flex" }}>
        <StackCard />
      </ScrollReveal>
    </div>
  );
