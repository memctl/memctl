  ...
  if (keyMatch) {
    return (
      <>
        ...
        <span className="text-[var(--landing-text-secondary)]">{keyMatch[4]}</span>
      </>
    );
  }
  ...
  useGSAP(
    () => {
      ...
      mm.add("(min-width: 1024px)", () => {
        ...
        // Swap connections
        if (leftConn)
          tl.to(leftConn, { opacity: 0.15, duration: 0.3 }, "<");
        if (rightConn)
          tl.to(rightConn, { opacity: 1, duration: 0.3 }, "<");
          ...
          <div className="mb-16 hidden items-center lg:flex">
            ...
            >
              ...
              <div className="relative h-[2px] w-full overflow-hidden rounded-full bg-[#F97316]/20">
                <div
                  className="absolute inset-0 animate-flow-right rounded-full"
                  style={{
                    backgroundImage:
